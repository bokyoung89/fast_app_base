    ...
    return BottomDialogScaffold(
        body: RoundedContainer(
            ...
            child: Column(
              children: [
                Row(
                  children: ['할일을 작성해주세요'.text.size(18).bold.make(),
                    spacer,
